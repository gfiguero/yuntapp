module Admin
  class RegionsController < ApplicationController
    ...
    def create
      ...
      if @region.save
        redirect_to admin_region_path(@region), notice: I18n.t("region.message.created")
      else
    ...
    def update
      if @region.update(region_params)
        redirect_to admin_region_path(@region), notice: I18n.t("region.message.updated"), status: :see_other
      else
    ...
    def destroy
      @region.destroy!
      redirect_to admin_regions_path, notice: I18n.t("region.message.destroyed"), status: :see_other, format: :html
    end

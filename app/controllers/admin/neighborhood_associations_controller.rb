  ...
  class NeighborhoodAssociationsController < ApplicationController
    ...
    def create
      ...
      if @neighborhood_association.save
        redirect_to admin_neighborhood_association_path(@neighborhood_association), notice: I18n.t("neighborhood_association.message.created")
      else
    ...
    def update
      if @neighborhood_association.update(neighborhood_association_params)
        redirect_to admin_neighborhood_association_path(@neighborhood_association), notice: I18n.t("neighborhood_association.message.updated"), status: :see_other
      else
    ...
    def destroy
      ...
      redirect_to admin_neighborhood_associations_path, notice: I18n.t("neighborhood_association.message.destroyed"), status: :see_other, format: :html
    end

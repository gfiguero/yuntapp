module Admin
  class CommunesController < ApplicationController
    ...
    def create
      ...
      if @commune.save
        redirect_to admin_commune_path(@commune), notice: I18n.t("commune.message.created")
      else
    ...
    def update
      if @commune.update(commune_params)
        redirect_to admin_commune_path(@commune), notice: I18n.t("commune.message.updated"), status: :see_other
      else
    ...
    def destroy
      @commune.destroy!
      redirect_to admin_communes_path, notice: I18n.t("commune.message.destroyed"), status: :see_other, format: :html
    end

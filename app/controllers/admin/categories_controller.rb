module Admin
  class CategoriesController < ApplicationController
    ...
    def create
      ...
      if @category.save
        redirect_to admin_category_path(@category), notice: I18n.t("category.message.created")
      else
    ...
    def update
      if @category.update(category_params)
        redirect_to admin_category_path(@category), notice: I18n.t("category.message.updated"), status: :see_other
      else
    ...
    def destroy
      @category.destroy!
      redirect_to admin_categories_path, notice: I18n.t("category.message.destroyed"), status: :see_other, format: :html
    end
